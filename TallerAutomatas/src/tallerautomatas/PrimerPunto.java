/*
 El siguiente código se crea para solucionar el primer punto del taller
Es un Lenguaje {0,1} con 4 estados (q0, q1, q2, q3)
 */
...
public class PrimerPunto {
    ...
    public static void main(String[] args) {
        ...
        try{
            if(afd.validate("000001000000111000000110"))//Validación de la cadena
